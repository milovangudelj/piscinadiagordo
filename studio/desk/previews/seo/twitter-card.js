...
const author = {
	name: "Milovan Gudelj",
	handle: "milovangudelj",
	image: "https://pbs.twimg.com/profile_images/1441504165130170375/zE4Tw5ZT_400x400.jpg",
};
	...
	render() {
		...
		return (
			<div className={styles.seoItem}>
				<h3 className={styles.seoItemTitle}>Anteprima Twitter</h3>
						...
						<div className={styles.seoItemCard}>
							<div className={styles.tweetWrapper} style={{ width }}>
								<div className={styles.tweetAuthor}>
									...
									/>
									<span className={styles.tweetAuthorName}>
										{author.name}
									</span>
								...
								<div className={styles.tweetUrlWrapper}>
									<div className={styles.tweetCardPreview}>
										...
										<div className={styles.tweetCardContent}>
											...
											{shareDesc && (
												<div
													className={styles.tweetCardDescription}
												>
													{shareDesc}
												</div>
											)}
